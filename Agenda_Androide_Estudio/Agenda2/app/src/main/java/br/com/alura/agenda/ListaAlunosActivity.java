...
public class ListaAlunosActivity extends AppCompatActivity {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, final ContextMenu.ContextMenuInfo menuInfo) {
        ...
        itemLigar.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if(ActivityCompat.checkSelfPermission(ListaAlunosActivity.this,Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
                    //o ultimo parametro é o requestcode que eu posso usar no metodo onRequestPermissionsResult logo abaixo(que é chamado sempre apos efetuar uma solicitação de permissão)
        ...
        //Aqui vamos usar uma intent implicita(e o android que decidi qual activity vai ser executada)
        ...
        //Aqui quando for clicado no item visita site, automaticamente vai dar um startActivity
    ...
    //é chamado sempre depois que é feita uma requisição de permissão
    @Override
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        super.onRequestPermissionsResult(requestCode, permissions, grantResults);

        //Faz a ligação
        //mesmo request code passado na permissão logo acima
        if(requestCode == 123){
